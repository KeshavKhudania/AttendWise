...
<head>
  ...
  <link rel="stylesheet" href="assets/css/saas-ui.css">
  <!-- endinject -->
...
<body class="">
  ...
  <div id="globalDialogContainer">
        ...
        <div class="modal-content shadow-sm">
          ...
          <div class="modal-footer" id="globalDialogFooter">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
              id="globalDialogCancel">Cancel</button>
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 12000;">
      <div id="globalDialogToast" class="toast align-items-center text-bg-dark border-0" role="alert"
        aria-live="assertive" aria-atomic="true" style="min-width:220px; display:none;">
        <div class="d-flex">
